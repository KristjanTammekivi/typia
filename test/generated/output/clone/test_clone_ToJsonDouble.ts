...
export const test_clone_ToJsonDouble = _test_clone("ToJsonDouble", ToJsonDouble.generate, (input) => ((input: ToJsonDouble.Parent): typia.Primitive<ToJsonDouble.Parent> => {
    ...
    return "object" === typeof input && null !== input && "function" === typeof input.toJSON ? "object" === typeof input.toJSON() && null !== input.toJSON() ? $co1(input.toJSON()) : input.toJSON() as any : input as any;
})(input));
