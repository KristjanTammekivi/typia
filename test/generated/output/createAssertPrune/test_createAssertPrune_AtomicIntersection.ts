...
export const test_createAssertPrune_AtomicIntersection = _test_assertPrune("AtomicIntersection", AtomicIntersection.generate, (input: any): AtomicIntersection => { const assert = (input: any): AtomicIntersection => {
...
}; assert(input); prune(input); return input; }, AtomicIntersection.SPOILERS);
