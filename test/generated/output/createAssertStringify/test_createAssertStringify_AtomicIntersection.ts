...
export const test_createAssertStringify_AtomicIntersection = _test_assertStringify("AtomicIntersection", AtomicIntersection.generate, (input: any): string => { const assert = (input: any): AtomicIntersection => {
...
}; return stringify(assert(input)); }, AtomicIntersection.SPOILERS);
