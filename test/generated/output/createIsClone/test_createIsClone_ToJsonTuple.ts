...
export const test_createIsClone_ToJsonTuple = _test_isClone("ToJsonTuple", ToJsonTuple.generate, (input: any): typia.Primitive<ToJsonTuple> | null => { const is = (input: any): input is ToJsonTuple => {
    ...
    return Array.isArray(input) && (input.length === 4 && true && true && true && true) ? [
        ...
        "object" === typeof input[3] && null !== input[3] && "function" === typeof input[3].toJSON ? "object" === typeof input[3].toJSON() && null !== input[3].toJSON() ? $co4(input[3].toJSON()) : input[3].toJSON() as any : input[3] as any
    ] as any : input as any;
}; if (!is(input))
