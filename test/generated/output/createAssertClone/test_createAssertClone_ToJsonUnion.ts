...
export const test_createAssertClone_ToJsonUnion = _test_assertClone("ToJsonUnion", ToJsonUnion.generate, (input: any): typia.Primitive<ToJsonUnion> => { const assert = (input: any): ToJsonUnion => {
    ...
    const $cp0 = (input: any) => input.map((elem: any) => "object" === typeof elem && null !== elem && "function" === typeof elem.toJSON ? "object" === typeof elem.toJSON() && null !== elem.toJSON() ? $cu0(elem.toJSON()) : elem.toJSON() as any : "object" === typeof elem && null !== elem ? $co0(elem) : elem as any);
