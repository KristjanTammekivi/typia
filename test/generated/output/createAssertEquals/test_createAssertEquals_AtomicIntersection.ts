...
export const test_createAssertEquals_AtomicIntersection = _test_assertEquals("AtomicIntersection", AtomicIntersection.generate, (input: any): AtomicIntersection => {
    const __is = (input: any, _exceptionable: boolean = true): input is AtomicIntersection => {
